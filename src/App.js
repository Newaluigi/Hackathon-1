...
function App() {
  ...
  return (
    <div className="App">
      <Routes>
        <Route path="/Intergalactic-tournament" element={<Home />} />
        <Route path="/characterslist" element={<CharactersList />} />
        <Route path="/tourlist" element={<TourList />} />
        <Route
          exact
          path="/CharactersList"
          element={<CharactersList setButton={setButton} />}
        />
        ...
        <Route
          exact
          path="/gameboard"
          element={<Tournament playerchoice={button} />}
        />
        <Route
          path="/gameboard/:result/:id"
          element={<Tournament playerchoice={button} />}
        />
      </Routes>
    </div>
